...
class _BattlePlayerSideState extends State<BattlePlayerSide> {
      ...
      child: Stack(
        children: <Widget>[
          Container(
            ...
            width: 281,
            child: Image.asset(
              'assets/projects/pokemon_fire_lava/pokemon_info_ui.png',
            ...
            child: Row(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Image.asset(
                    'assets/projects/pokemon_fire_lava/male.png',
                    fit: BoxFit.fitHeight,
          ...
          Container(
            margin: EdgeInsets.only(top: 63, left: 208),
            child: Text(
              "20 / 20",
              style: TextStyle(
                fontFamily: 'PokemonFireRed',
        ...
        Stack(
          ...
          children: <Widget>[
            Container(
              ...
              child: Image.asset(
                'assets/projects/pokemon_fire_lava/grass-player.png',
                fit: BoxFit.fitHeight,
            ...
            Container(
              ...
              margin: EdgeInsets.only(left: kToolbarHeight),
              child: Image.asset(
                'assets/projects/pokemon_fire_lava/pikachu.png',
                fit: BoxFit.fitHeight,
                alignment: Alignment.bottomLeft,
              ),
            ),
  ...
  Widget _displaysCharacterAnimation() {
    return Container(
      height: 120,
      child: NimaActor(
        "assets/projects/pokemon_fire_lava/pokemon_main_character.nma",
        alignment: Alignment.bottomLeft,
